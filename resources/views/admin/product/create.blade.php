    ...
    <div class="form-row">
            ...
            <div class="form-row" id="new_keyword">
               <h4 class="m-auto"> add 5 key words</h4>
                <div class="form-group col-md-12">
                    {!! Form::text('keyword_1', null, ['class'=>'form-control' , 'placeholder'=>'keywords'])!!}
                </div>
                <div class="form-group col-md-12">
                    {!! Form::text('keyword_2', null, ['class'=>'form-control' , 'placeholder'=>'keywords'])!!}
                </div>
                <div class="form-group col-md-12">
                    {!! Form::text('keyword_3', null, ['class'=>'form-control' , 'placeholder'=>'keywords'])!!}
                </div>
                <div class="form-group col-md-12">
                    {!! Form::text('keyword_4', null, ['class'=>'form-control' , 'placeholder'=>'keywords'])!!}
                </div>
                <div class="form-group col-md-12">
                    {!! Form::text('keyword_5', null, ['class'=>'form-control' , 'placeholder'=>'keywords'])!!}
                </div>
            </div>
        </div>
        ...
        <div class="col-6">
            <div class="form-row" id="new_color">
                ...
                <div class="form-group col-md-12">
                    {!! Form::text('color_1', null, ['class'=>'form-control' , 'placeholder'=>'colors'])!!}
                </div>
                <div class="form-group col-md-12">
                    {!! Form::text('colors_2', null, ['class'=>'form-control' , 'placeholder'=>'colors'])!!}
                </div>
                <div class="form-group col-md-12">
                    {!! Form::text('colors_3', null, ['class'=>'form-control' , 'placeholder'=>'colors'])!!}
                </div>
                <div class="form-group col-md-12">
                    {!! Form::text('colors_4', null, ['class'=>'form-control' , 'placeholder'=>'colors'])!!}
                </div>
                <div class="form-group col-md-12">
                    {!! Form::text('colors_5', null, ['class'=>'form-control' , 'placeholder'=>'colors'])!!}
                </div>
            </div>
